...
function smart_fastfetch
    if status --is-interactive && type -q fastfetch
        ...
        set full_width_threshold 160

        if test $cols -ge $full_width_threshold
            fastfetch -l arch3 --config /home/vorsv/fastfetch/defaultNewer.jsonc
        else
            fastfetch -l arch3 --config  /home/vorsv/fastfetch/neofetch.jsonc
        end
    end
end
